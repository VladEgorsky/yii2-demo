    ...
    <div class="comment-index">
        ...
        <?= GridView::widget([
            ...
            'columns' => [
                ...
                [
                    'format' => 'raw',
                    'label' => 'News title/content',
                    'filter' => Html::activeTextInput($searchModel, 'newsTitle', ['class' => 'form-control']),
                    'value' => function ($model) {
                        return StringHelper::truncate($model->news->title, Yii::$app->params['ingridStringMaxLength']);;
                    }
                ],
                [
                    'format' => 'raw',
