...
$sidebar = $_COOKIE['sidebar'] ?? 'expanded';
$bodyClass = ($sidebar == 'collapsed') ? 'sidebar-collapse ' : '';
?>
...
<body class="hold-transition sidebar-mini <?= $bodyClass . \dmstr\helpers\AdminLteHelper::skinClass() ?>">
<?php $this->beginBody() ?>
